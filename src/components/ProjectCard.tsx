    ...
    >
      ...
      <div className="p-6 relative z-10 h-full flex flex-col">
        ...
        <div className="flex justify-between items-start mb-4">
          ...
          <span className={`px-3 py-1 rounded-full text-xs font-semibold ${statusColors.background} ${statusColors.text} whitespace-nowrap flex-shrink-0 border ${statusColors.text.replace('text', 'border')} opacity-80`}>
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className={`w-3 h-3 rounded-full bg-gradient-to-r ${getProgressGradient(project.progress)}`} />
            </div>
          </div>
          ...
          <div className="w-full bg-gray-200 rounded-full h-2.5 mb-2 overflow-hidden">
            <div 
              className={`h-2.5 rounded-full transition-all duration-700 ease-out bg-gradient-to-r ${getProgressGradient(project.progress)} shadow-sm`}
        ...
        <div className="mt-auto pt-4 border-t border-gray-200 group-hover:border-gray-300 transition-colors">
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="p-2 cursor-pointer text-red-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200 hover:scale-110 group/delete"
